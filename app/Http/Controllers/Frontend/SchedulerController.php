...
class SchedulerController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.schedulers.index', compact('schedulers'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.schedulers.create', compact('habits', 'users'));
    }
    ...
    public function store(StoreSchedulerRequest $request)
    {
        ...
        return redirect()->route('frontend.schedulers.index');
    }
    ...
    public function edit(Scheduler $scheduler)
    {
        ...
        return view('frontend.schedulers.edit', compact('habits', 'scheduler', 'users'));
    }
    ...
    public function show(Scheduler $scheduler)
    {
        ...
        return view('frontend.schedulers.show', compact('scheduler'));
    }

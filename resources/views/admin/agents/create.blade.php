    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.agents.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('review_results') ? 'is-invalid' : '' }}" name="review_results" id="review_results">{{ old('review_results') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_reviewed') ? 'is-invalid' : '' }}" type="text" name="date_reviewed" id="date_reviewed" value="{{ old('date_reviewed') }}">

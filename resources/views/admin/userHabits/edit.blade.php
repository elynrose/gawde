...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.user-habits.update", [$userHabit->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('notify_by_email') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="notify_by_email" id="notify_by_email" value="1" {{ $userHabit->notify_by_email || old('notify_by_email', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('send_sms_reminder') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="send_sms_reminder" id="send_sms_reminder" value="1" {{ $userHabit->send_sms_reminder || old('send_sms_reminder', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('agreed_to_terms') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="agreed_to_terms" id="agreed_to_terms" value="1" {{ $userHabit->agreed_to_terms || old('agreed_to_terms', 0) === 1 ? 'checked' : '' }} required>

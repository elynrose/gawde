    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.schedulers.update", [$scheduler->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="today" id="today" value="{{ old('today', $scheduler->today) }}" required>
                            @if($errors->has('today'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('today') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="reminded" id="reminded" value="1" {{ $scheduler->reminded || old('reminded', 0) === 1 ? 'checked' : '' }}>

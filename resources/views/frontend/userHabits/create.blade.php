    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.user-habits.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="notify_by_email" id="notify_by_email" value="1" {{ old('notify_by_email', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="send_sms_reminder" id="send_sms_reminder" value="1" {{ old('send_sms_reminder', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                <input type="checkbox" name="agreed_to_terms" id="agreed_to_terms" value="1" required {{ old('agreed_to_terms', 0) == 1 ? 'checked' : '' }}>

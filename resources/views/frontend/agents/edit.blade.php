                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.agents.update", [$agent->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="review_results" id="review_results">{{ old('review_results', $agent->review_results) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_reviewed" id="date_reviewed" value="{{ old('date_reviewed', $agent->date_reviewed) }}">

<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('habit_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.habits.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/habits") || request()->is("admin/habits/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-allergies c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.habit.title') }}
                </a>
            </li>
        @endcan
        @can('survey_access')
        ...
        @endcan
        @can('scheduler_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.schedulers.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/schedulers") || request()->is("admin/schedulers/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-clock c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.scheduler.title') }}
                </a>
            </li>
        @endcan
        @can('user_habit_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.user-habits.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/user-habits") || request()->is("admin/user-habits/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-angry c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.userHabit.title') }}
                </a>
            </li>
        @endcan
